class GuardiansOfTheGalaxy {
    public int approximateMembersCount;
    public Power mainPower;
    public Weapon mainWeapon;
    public Vehicle mainVehicle;

    public GuardiansOfTheGalaxy(int approximateMembersCount, Power mainPower, Weapon mainWeapon, Vehicle mainVehicle) {
    ...
    public void displayGuardiansDetails() {
        System.out.println("Approximate Active Guardians Members: " + approximateMembersCount);
